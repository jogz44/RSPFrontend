        ...
        <div class="modal-container">
          ...
          <div class="modal-header">
            <div class="modal-header-left">
              <i class="ti ti-calendar-cancel" aria-hidden="true"></i>
              <span id="email-modal-heading">Interview Cancellation Notification Preview</span>
            </div>
              ...
              <div class="letter-container">
                ...
                <div class="letter-body">
                  ...
                  <div class="details-section">
                    <p class="details-title">Cancelled Interview Details:</p>
                    <table class="details-table">
                      <tr>
                        <td class="details-label">Date:</td>
                        <td class="details-value">
                          <strong>{{ formatDate(interviewDetails?.date_interview) }}</strong>
                        </td>
                      </tr>
                      <tr>
                        <td class="details-label">Time:</td>
                        <td class="details-value">
                          <strong>{{ formatTime(interviewDetails?.time_interview) }}</strong>
                        </td>
                      </tr>
                      <tr>
                        ...
                        <td class="details-value">
                          <strong>
                            {{ interviewDetails?.venue_interview || 'Not specified' }}
                          </strong>
                        </td>
                      </tr>
                    </table>
                  ...
                  <p class="letter-text">
                    ...
                    caused. Please be patient and wait for the updated interview schedule. Thank
                    you.
                  </p>
                  ...
                  <div class="reminders-section">
                    ...
                    <ul class="reminders-list">
                      <li>
                        Please disregard any previous notice regarding the above interview schedule.
                      </li>
...
<script setup>
  ...
  const props = defineProps({
    ...
    interviewDetails: { type: Object, default: null },
  ...
  const displayPosition = computed(
    () => extractPosition(props.applicant) || props.interviewDetails?.position || 'N/A',
  );
  const displayOffice = computed(
    () => extractOffice(props.applicant) || props.interviewDetails?.office || 'N/A',
  );
  const displayItemNo = computed(
    () => extractItemNo(props.applicant) || props.interviewDetails?.itemNo || null,
  );
    ...
    try {
      ...
      const docDefinition = {
        ...
        content: [
          ...
          // Cancellation notice box
          {
            table: {
              ...
              body: [
                [
                  {
                    text: '⚠ NOTICE: Your scheduled interview has been CANCELLED.',
                    fontSize: FONT_SIZE,
                    bold: true,
                    color: '#c0392b',
                    fillColor: '#fff5f5',
          ...
          {
            text: 'Please be informed that the Behavioral Event Interview with the Human Resource Merit Promotion and Selection Board (HRMPSB) originally scheduled on:',
            fontSize: FONT_SIZE,
            alignment: 'justify',
            margin: [0, 0, 0, 10],
          },
          ...
          {
            text: 'Cancelled Interview Details:',
            fontSize: FONT_SIZE,
            bold: true,
            margin: [0, 0, 0, 4],
          },
            ...
            table: {
              ...
              body: [
                [
                  ...
                  {
                    text: formatDate(iv?.date_interview),
                    fontSize: FONT_SIZE,
                    bold: true,
                    border: [false, false, false, false],
                  },
                ...
                [
                  ...
                  {
                    text: formatTime(iv?.time_interview),
                    fontSize: FONT_SIZE,
                    bold: true,
                    border: [false, false, false, false],
                  },
                ...
                [
                  ...
                  {
                    text: iv?.venue_interview || 'Not specified',
                    fontSize: FONT_SIZE,
                    bold: true,
                    border: [false, false, false, false],
                  },
          ...
          {
            text: 'has been cancelled. We sincerely apologize for any inconvenience this may have caused. Please be patient and wait for the updated interview schedule. Thank you.',
            fontSize: FONT_SIZE,
            alignment: 'justify',
            margin: [0, 0, 0, 10],
          },
