        ...
        <div class="modal-container">
          ...
          <div class="modal-header">
            <div class="modal-header-left">
              ...
              <span id="email-modal-heading">Interview Notification Preview</span>
            </div>
              ...
              <div class="letter-container">
                ...
                <div class="letter-body">
                  ...
                  <p class="letter-text">
                    ...
                    a
                    <strong>Competency-Based Interview</strong>
                    as part of our recruitment process. As such, kindly refer to the interview
                    schedule below:
                  </p>

                  <div class="details-section">
                    <p class="details-title">Interview Details:</p>
                    <table class="details-table">
                      ...
                      <tr>
                        ...
                        <td class="details-value">
                          <strong>{{ interviewDetails?.venue_interview || '' }}</strong>
                        </td>
                      </tr>
                    </table>
                  </div>
                  ...
                  <div class="reminders-section">
                    ...
                    <ul class="reminders-list">
                      <li>
                        Please arrive at least 30 minutes before your scheduled time of interview.
                      </li>
                      <li>Bring a valid ID for identification purposes.</li>
                      <li>Observe proper/decent dress code when coming to an interview.</li>
                      <li>
        ...
        content: [
          ...
          },
          {
            text: [
              ...
              { text: 'Competency-Based Interview', bold: true },
          ...
          // Interview Details
          { text: 'Interview Details:', fontSize: FONT_SIZE, bold: true, margin: [0, 0, 0, 4] },
          {
            table: {
              widths: ['15%', '85%'],
              body: [
          ...
          },
          {
            ul: [
              ...
              'Observe proper/decent dress code when coming to an interview.',
