      ...
      >
        <div class="modal-container">
              ...
              <div class="letter-container">
                ...
                <div class="letter-body">
                  ...
                  <div class="system-notice">
                    ...
                    This is a system-generated email preview.
                  </div>
                </div>
              </div>
            </div>
          ...
          <div class="modal-footer">
            <q-btn flat label="Close" @click="$emit('close')" color="primary" />
          </div>
        </div>
      </div>
    </Transition>
...
<script setup>
  ...
  const displayPosition = computed(() => {
    return extractPosition(props.applicant) || props.interviewDetails?.position || 'N/A';
  });

  const displayOffice = computed(() => {
    return extractOffice(props.applicant) || props.interviewDetails?.office || 'N/A';
  });

  const displayItemNo = computed(() => {
    return extractItemNo(props.applicant) || props.interviewDetails?.itemNo || null;
  });
